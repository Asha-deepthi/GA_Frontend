...
const SectionSetupPage = ({ onBack, onNext, initialQuizData }) => {
    const [sections, setSections] = useState([{ id: 1, name:'Section 1', type: 'mcq', timeLimit: '00:00:00', numQuestions: 5, shuffleQuestions: true, shuffleAnswers: true, instructions: '', marksPerQuestion: '', maxMarks: '', minMarks: '', negativeMarks: '' }]);
