      ...
      <div className="bg-white w-[400px] h-[250px] rounded-[24px] flex flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-evenly w-full h-full">
          ...
          <div className="text-center">
            <p className="text-[#1C0D0D] text-[22px] font-lexend font-bold">Audio was Unclear</p>
            <p className="text-[#1C0D0D] text-[16px] font-lexend font-medium">Please stay audible.</p>
          </div>
          {/* Buttons */}
