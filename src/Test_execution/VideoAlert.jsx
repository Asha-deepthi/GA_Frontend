      ...
      <div className="bg-white w-[560px] h-[240px] rounded-[24px] flex flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-evenly w-full h-full">
          ...
          <div className="text-center">
            <p className="text-[#1C0D0D] text-[16px] font-lexend font-bold">Video was Unclear</p>
            <p className="text-[#1C0D0D] text-[10px] font-lexend font-medium">Please adjust your lighting, Signal or camera.</p>
          </div>
