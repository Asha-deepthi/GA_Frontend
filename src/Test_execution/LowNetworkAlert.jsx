...
const LowNetworkAlert = ({ onDismiss}) => {
  return (
      ...
      <div className="bg-white w-[560px] h-[240px] rounded-[24px] flex flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-evenly w-full h-full">
          ...
          <div className="text-center">
            <p className="text-[#1C0D0D] text-[16px] font-lexend font-bold">Low network is detected</p>
            <p className="text-[#1C0D0D] text-[10px] font-lexend font-medium">Your connection may effect the session.</p>
          </div>

          {/* Buttons */}
          <div className="flex justify-center">
            <button
              className="w-[320px] h-[32px] rounded-[4px] bg-[#ED3237] text-white font-lexend font-bold text-[12px]"
              onClick={onDismiss}
            >
              Dismiss
            </button>
