  ...
  return (
    <div className="w-screen min-h-screen bg-white font-overpass relative overflow-x-hidden overflow-y-auto pb-24">
      ...
      <main className="relative max-w-[1250px] mx-auto px-4 sm:px-8 pb-10 pt-[130px] flex flex-col items-center text-center">
        ...
        >
          <button
            className="text-sm font-medium border border-white bg-white text-black px-4 py-2 rounded-full mb-4 sm:mb-0 self-start sm:self-auto"
          >
            &larr; Back
          </button>
        ...
        {/* Submit Button */}
        <button
          className="w-[218px] h-[44px] bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-full transition flex items-center justify-center mb-8 mx-auto"
        >
          Submit & Continue
        </button>
      </main>
