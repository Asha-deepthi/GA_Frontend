...
export default function PermissionScreen() {
  ...
  return (
    <div className="w-screen min-h-screen bg-white flex flex-col items-center justify-start relative overflow-hidden font-overpass overflow-x-hidden overflow-y-auto">
