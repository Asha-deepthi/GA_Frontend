...
const MultiplePersonsAlert = ({ onDismiss, onContinue }) => (
    ...
    <div className="bg-white w-[560px] h-[240px] rounded-[24px] flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-evenly w-full h-full">
        ...
        <div className="w-[92px] h-[92px] rounded-full bg-[#00A3981A] flex items-center justify-center">
          <img
            src="/images/multiplefaces.png"
            alt="Multiple persons detected"
        ...
        <p className="text-[#1C0D0D] text-[16px] font-lexend font-bold leading-[24px] text-center">
          Multiple faces detected! Please ensure you're alone during the exam.
        </p>
...
export default MultiplePersonsAlert;
