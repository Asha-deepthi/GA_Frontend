...
// --- Reusable SVG Icon Components (for clean code) ---
    ...
    if (!isSubmitting) {
        ...
        return (
            <div className="proctored-test-page">
                 ...
                 <header> {/* Header is the same in both views */}
                    <div className="test-title"><MenuIcon /><span>GA Proctored Test</span></div>
                    <nav className="header-nav">
                        <button className="faq-btn"><FaqIcon /> FAQs</button>
